...
export default async function DiscoverPage() {
  ...
  return (
    <AppShell
      ...
      mainOverflow="hidden"
    >
      <main className="flex min-h-0 flex-1 flex-col overflow-hidden p-6 px-7 lg:p-7">
        ...
        <header className="mb-6 max-w-3xl shrink-0">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-y-contain [-webkit-overflow-scrolling:touch]">
          ...
          {source !== "youtube" ? (
            <p className="mb-8 rounded-lg border border-dashed border-zinc-700 bg-zinc-900/40 px-4 py-3 text-sm text-muted">
              ...
              <strong className="text-zinc-300">Google for YouTube</strong> to
              load real Discover results per category.
            </p>
          ) : null}
